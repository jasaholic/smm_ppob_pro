...
<head>
    ...
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="src/assets/css/dashlite.css?ver=2.2.0">
    <link id="skin-default" rel="stylesheet" href="src/assets/css/theme.css?ver=2.2.0">
</head>
...
<body class="nk-body npc-invest bg-lighter ">
                        ...
                        <div class="nk-header-menu" data-content="headerNav">
                            ...
                            <ul class="nk-menu nk-menu-main ui-s2">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="html/index-sales.html" class="nk-menu-link">
                                                <span class="nk-menu-text">Pulsa</span>
                                            </a>
                                        </li><!-- .nk-menu-item -->
                                        <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="html/apps-messages.html" class="nk-menu-link"><span class="nk-menu-text">Pembelian Pulsa</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Pembelian Game</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-file-manager.html" class="nk-menu-link"><span class="nk-menu-text">Pembelian Sosmed</span></a>
                                        </li>
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="html/apps-messages.html" class="nk-menu-link"><span class="nk-menu-text">Topup</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Riwayat</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Pemakaian Saldo</span></a>
                                        </li>
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="html/apps-messages.html" class="nk-menu-link"><span class="nk-menu-text">Buat Baru</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Riwayat</span></a>
                                        </li>
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        <span class="nk-menu-text">Halaman</span>
                                    </a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="html/apps-messages.html" class="nk-menu-link"><span class="nk-menu-text">F.A.Q</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Daftar Harga</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Rest API</span></a>
                                        </li>
                                    ...
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <div class="user-toggle">
                                            ...
                                            <div class="user-info d-none d-xl-block">
                                                <div class="user-status">Abu Bin Ishityak</div>
                                                <div class="user-name dropdown-indicator">Rp.15000</div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des text-soft">
                                            <p>Welcome to Nama Panel Dashboard Template.</p>
                                        </div>
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="src/assets/js/bundle.js?ver=2.2.0"></script>
    <script src="src/assets/js/scripts.js?ver=2.2.0"></script>
    <script src="src/assets/js/charts/gd-invest.js?ver=2.2.0"></script>
</body>
